...
public class ContaCorrente {
    ...
    // construtor que inicializa os atributos titular, agencia, numContaCorrente e
    // saldo com os valores passados através dos parâmetros desse método.
    ...
    // se o valor a ser creditado, passado como parâmetro para esse método, for
    // positivo: incrementa o saldo da conta-corrente com o valor de crédito
    // informado.
    ...
    // se a quantia a ser sacada, passada como parâmetro para esse método, for
    // positiva, e houver saldo suficiente: decrementa, do saldo atual da
    // conta-corrente, a quantia informada.
